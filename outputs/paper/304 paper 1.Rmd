---
title: "The dangrous of shooting in different time range"
date: "2022/02/05"
...
data1 = data %>%
  select(Day_of_week, Time_Range, Death, Injuries, Hood_ID, Neighbourhood)
```
...
```{r 2, echo=FALSE, fig.height=6, fig.width=8}
library(ggplot2)
...
```{r 4, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
